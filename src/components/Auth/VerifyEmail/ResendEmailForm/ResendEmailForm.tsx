    ...
    return (
        <form onSubmit={formik.handleSubmit} className={styles.resendEmailForm}>
                        ...
                        <FormControl isInvalid={!!formik.errors.email && formik.touched.email}>
                            <Input aria-label="email" id="email" name="email" type="email" value={formik.values.email} placeholder="Please enter your email address" onChange={formik.handleChange}></Input>
